...
class amq implements Callback {
    ...
    L_0x003f:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.amq.handleMessage(android.os.Message):boolean");
    }

    amq(ProfileInfoActivity profileInfoActivity) {
