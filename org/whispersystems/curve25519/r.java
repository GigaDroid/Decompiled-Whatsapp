...
public class r {
    public static void a(int[] iArr, int[] iArr2) {
        ...
        j19 = (((j2 + j27) + j33) + j38) + j42;
        j11 = ((((j11 + j3) + j34) + j39) + j43) + j46;
        j34 = (((j4 + j12) + j40) + j44) + j47;
        j48 += (j45 + ((j5 + j13) + j20)) + (((long) (i7 * 2)) * ((long) i20));
        j45 = (((j6 + j14) + j21) + (((long) i7) * ((long) i21))) + j49;
        j28 = ((j28 + ((j7 + j15) + j22)) + (((long) i17) * ((long) i21))) + j50;
        long j52 = ((j8 + j16) + j23) + j29;
        j52 += ((long) i9) * r0;
        long j53 = (((long) i10) * ((long) i21)) + ((((j9 + j17) + j24) + j30) + j35);
        j46 = (((j10 + j18) + j25) + j31) + j36;
        j41 += j41;
        j48 += j48;
        j50 = (33554432 + j41) >> 26;
        j19 = (j19 + j19) + j50;
